...
const WriteArticle = () => {
  ...
  const articleLength=[
    {length: 1800, text: 'Short (500-800 words)'},
    {length: 2000, text: 'Medium( 800-1200 words)'},
...
Use introduction, headings, examples and conclusion.
Minimum words: ${selectedLength.text}.`
